...
$module_constant = 'INSTANT_SEARCH_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/instantSearch';
$module_name = 'Instant Search';
$module_file_for_version_check = '';
$zencart_com_plugin_id = 1336;
